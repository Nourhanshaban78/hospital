  ...
  <header>
    ...
    <nav class="navbar navbar-expand-lg navbar-light shadow-sm">
      <div class="container">
        ...
        <li class="nav-item">
              <a class="nav-link" href="<?php echo e(url('/myapp')); ?>">My Appoinment</a>
            </li>
...
<div>
  ...
  <tbody>
    ...
    <tr>
      <th scope="row"><?php echo e($app->doctor); ?></th>
      <td><?php echo e($app->date); ?></td>
      <td><?php echo e($app->message); ?></td>
      <td><?php echo e($app->status); ?></td>
      <td><a  class="btn btn-danger" href="<?php echo e(url('delete',$app->id)); ?>"  onclick="return confirm('Are you sure to delete the message')">Delete</a></td>
...
</html><?php /**PATH E:\totorial\hospital\resources\views/user/myapp.blade.php ENDPATH**/ ?>