  ...
  <header>
    ...
    <nav class="navbar navbar-expand-lg navbar-light shadow-sm">
      <div class="container">
        ...
        @auth
        <li class="nav-item">
              <a class="nav-link" href="{{url('/myapp')}}">My Appoinment</a>
            </li>
      ...
      <div class="container">
        <div class="row align-items-center">
          <div class="col-lg-6 py-3 wow fadeInUp">
            ...
            <p class="text-grey mb-4">Welcome to Memorial Hospital and Health Care Center's website! Our site holds a wealth of information about the services and programs we offer for our regional community as well as general health news, a provider listing and career opportunities.
...
Again, thank you for allowing us to serve you during what is most likely a very vulnerable time in your life. I appreciate the significant trust you place in us!</p>
